      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/60" style={{ fontFamily: 'Inter, sans-serif' }}>
            Create Your AI Protection Account
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#00d4ff]/60" />
                <input
                  id="name"
                  type="text"
                  value={name}
            ...
            <div>
              ...
              <div className="relative">
                <CheckCircle className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#00d4ff]/60" />
                <input
                  id="confirmPassword"
                  type="password"
